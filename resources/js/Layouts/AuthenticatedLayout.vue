                    ...
                    <div class="flex h-16 justify-between">
                        ...
                        >
                            ...
                            <div class="flex items-center">
                                <button
                                    type="button"
                                    class="inline-flex items-center rounded-md border border-transparent bg-white p-2 text-sm font-medium text-gray-500 hover:text-gray-700 focus:outline-none"
                                >
                                    <BellIcon
                                        class="h-5 w-5"
                                        aria-hidden="true"
